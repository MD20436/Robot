...
void stop_motors();
void reverse_motors();
void turn_left_sonar();
void turn_right_sonar();
void turn_forward_sonar();
void turn_left_os();
void turn_right_os();
void turn_forward_os();
...
int main(void)
{
  ...
  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 240);
  __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 180);
...
void manual_control(char cmd)
{
   ...
   //  	HAL_Delay(50);
    ...
    //	HAL_Delay(50);
        ...
        break;
    case 'e':
    	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 260);
        break;
    case 'z':
    	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 180);
        break;
...
uint32_t measure_distance() {
  ...
  void control_loop() {
      frontDistance = measure_distance();
  ...
  void turn_left_sonar() {
      __HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_1, 190);
  }
  ...
  void turn_left_os() {
  	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 310);
  }

  void turn_right_os() {
  	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 170);
  }
  void turn_forward_os() {
  	__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_2, 240);
  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : przycisk_Pin PA8 */
  GPIO_InitStruct.Pin = przycisk_Pin|GPIO_PIN_8;
